...
def runit(filename):
    ...
    if aktionen.hasAttribute("saison"):
        ...
        print ("Saison : %s" % saison)
    else:
        print ("Saison Attribute im Root-Element nicht gefunden, dies ist mandatory")
        print ("Erste Zeile des Files muss so aussehen:")
        print ("<aktionen saison = Sommersaison XXXX>")
        error.append(1)
        return(error)
    ...
    for dose in dosen:
        ...
        nummer = dose.getElementsByTagName('dose_nr')[0]
